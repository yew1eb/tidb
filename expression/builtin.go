...
var funcs = map[string]functionClass{
	...
	ast.AddDate1:         &dateArithFunctionClass{baseFunctionClass{ast.AddDate1, 3, 3}, ast.DateArithAdd},
	ast.AddTime1:         &addTime1FunctionClass{baseFunctionClass{ast.AddTime1, 2, 2}},
	ast.SubDate1:         &dateArithFunctionClass{baseFunctionClass{ast.SubDate1, 3, 3}, ast.DateArithSub},
	ast.SubTime1:         &subTime1FunctionClass{baseFunctionClass{ast.SubTime1, 2, 2}},
	...
	ast.TimeDiff1:        &timeDiff1FunctionClass{baseFunctionClass{ast.TimeDiff1, 2, 2}},
	...
	ast.InsertFunc1:     &insertFuncFunctionClass1{baseFunctionClass{ast.InsertFunc1, 4, 4}},
	ast.Instr:           &instrFunctionClass{baseFunctionClass{ast.Instr, 2, 2}},
	ast.Instr1:          &instrFunctionClass1{baseFunctionClass{ast.Instr1, 2, 2}},
	ast.Lcase:           &lowerFunctionClass{baseFunctionClass{ast.Lcase, 1, 1}},
	ast.Left:            &leftFunctionClass{baseFunctionClass{ast.Left, 2, 2}},
	ast.Left1:           &leftFunctionClass1{baseFunctionClass{ast.Left1, 2, 2}},
	...
	ast.Lpad1:           &lpadFunctionClass1{baseFunctionClass{ast.Lpad1, 3, 3}},
	...
	ast.Hex1:            &hexFunctionClass1{baseFunctionClass{ast.Hex1, 1, 1}},
	...
	ast.EQ1:        &compare1FunctionClass{baseFunctionClass{ast.EQ1, 2, 2}, opcode.EQ1},
	...
	ast.Plus1:      &arithmeticFunctionClass{baseFunctionClass{ast.Plus1, 2, 2}, opcode.Plus1},
	ast.Minus1:     &arithmeticFunctionClass{baseFunctionClass{ast.Minus1, 2, 2}, opcode.Minus1},
	ast.Div1:       &arithmeticFunctionClass{baseFunctionClass{ast.Div1, 2, 2}, opcode.Div1},
	ast.Mul1:       &arithmeticFunctionClass{baseFunctionClass{ast.Mul1, 2, 2}, opcode.Mul1},
	ast.IntDiv1:    &arithmeticFunctionClass{baseFunctionClass{ast.IntDiv1, 2, 2}, opcode.IntDiv1},
